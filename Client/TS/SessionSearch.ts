...
const detail_id = document.getElementById("1v1-search-detail-id") as HTMLLabelElement;
const detail_reason = document.getElementById("1v1-search-detail-reason") as HTMLLabelElement;
const detail_winner = document.getElementById("1v1-search-detail-winner") as HTMLLabelElement;

const detail_l_user = document.getElementById("1v1-search-detail-l-user") as HTMLLabelElement;
const detail_l_state = document.getElementById("1v1-search-detail-l-state") as HTMLLabelElement;
const detail_l_score = document.getElementById("1v1-search-detail-l-score") as HTMLLabelElement;

const detail_r_user = document.getElementById("1v1-search-detail-r-user") as HTMLLabelElement;
const detail_r_state = document.getElementById("1v1-search-detail-r-state") as HTMLLabelElement;
const detail_r_score = document.getElementById("1v1-search-detail-r-score") as HTMLLabelElement;
